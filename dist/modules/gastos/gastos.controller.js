...
const gastosService = __importStar(require("./gastos.service"));
async function findAll(req, res) {
    const { page, limit } = req.query;
    const result = await gastosService.findAll(req.user.id, page ? Number(page) : undefined, limit ? Number(limit) : undefined);

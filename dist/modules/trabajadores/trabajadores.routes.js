...
const trabajadoresController = __importStar(require("./trabajadores.controller"));
...
router.put("/:id", (0, validate_middleware_1.validate)(trabajadores_schema_1.updateTrabajadorSchema), trabajadoresController.update);

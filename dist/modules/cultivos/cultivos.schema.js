...
exports.createCultivoSchema = zod_1.z.object({
    tipo: zod_1.z.enum(["CAFE", "CANA_AZUCAR"]),
    ...
    numeroSoca: zod_1.z.number().int().positive().optional(),
    edadCafetal: zod_1.z.number().int().positive().optional(),
    plantasPorHectarea: zod_1.z.number().positive().optional(),
    rendimientoEstimado: zod_1.z.number().positive().optional(),
